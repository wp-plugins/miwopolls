...
class plgContentMiwopolls extends MPlugin {
	...
	function _renderModule($module, $attribs = array(), $id)	{
		...
		$path = MPATH_BASE.'/modules/'.DS.$module->module.'/'.$module->module.'.php';
		...
		require_once (MPATH_BASE.DS.'templates'.DS.'system'.DS.'html'.DS.'modules.php');
		$chromePath = MPATH_BASE.DS.'templates'.DS.$mainframe->getTemplate().DS.'html'.DS.'modules.php';
